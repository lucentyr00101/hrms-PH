...
const app = {
  ...
  actions: {
    ...
    ToggleTheme ({ commit }, bool) {
      commit(TOGGLE_NAV_THEME, bool)
    },
    ToggleFixSiderbar ({ commit }, bool) {
      commit(TOGGLE_FIXED_SIDEBAR, bool)
    },
    ToggleFixedHeader ({ commit }, bool) {
      commit(TOGGLE_FIXED_HEADER, bool)
    },
    ToggleLayoutMode ({ commit }, bool) {
      commit(TOGGLE_LAYOUT, bool)
    }
  }
}
