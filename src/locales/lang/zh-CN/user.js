export default {
  ...
  'user.login.username.placeholder': 'admin/super/admin2/admin3/admin4',
  'user.login.password.placeholder': 'admin/super',
  'user.login.message-invalid-credentials': 'Username or Password invalid',
  ...
  'user.userName.required': 'Please enter a valid username',
